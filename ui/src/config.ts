...
export const CONFIG = {
  ...
  vertexAi: {
    ...
    - Scenes with the most logos, most brands, most products or most on-screen text are VITAL. Combinations MUST ALWAYS include these scenes.
    ...
    1 point: The generated combination meets very few or none of the ABCD criteria, or it uses ALL the scenes of the original video ad.
    ...
    Add 3 line breaks after each combination you output.
